...
suffix = "_maxFiltered.tiff" //change this line each run to conform to maxFiltered naming convention
...
function getROIs(input, file) {
	...
	//run("Apply LUT");
			...
			run("Analyze Particles...", "size=20-1000 add"); //Find list of ROIs with small size
