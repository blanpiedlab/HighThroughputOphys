...
sensor = "GluSnFR3" #If sensor_override is TRUE, here you can define a sensor from among the following: c('GluSnFR3',"JF646",'GCaMP8m','GCaMP8f','jRGECO'). JF646 refers to JF646-BAPTA; refer to Deo et al. JACS 2019.
