...
minimum_window_duration = 0.75
k_duration_normal = 0.04 #s
k_duration_long = 0.04 #s
...
rm(list=ls()[! ls() %in% c("data_flagged","groupers",'showGraphs','mainDir','path','n','savePlots','randomROIs','ROIs','ROIs_to_sample')])  #clear all vars in memory except for flagged data.
