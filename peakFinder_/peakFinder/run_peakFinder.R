...
setwd("Y:\\Sam/post_paper1_datasets/HNK/initial_exp_1Ca_30uM_HNK/.csv/stamped")
...
savePlots = TRUE
mainDir <- "Y:\\Sam/post_paper1_datasets/HNK/initial_exp_1Ca_30uM_HNK/Figures/HNK_analysis_v1/peakFinder_outputs_v2" #set directory for Figures
n =10#a number: # of traces / n is the % of plots to save out
# 
tic()
