...
rm(list=ls()[! ls() %in% c("peaksHeavy","groupers",'showGraphs','savePlots','mainDir','path', 'n','randomROIs','ROIs','ROIs_to_sample','toggle_short_peaks')])  #clear all vars in memory except for flagged data.
