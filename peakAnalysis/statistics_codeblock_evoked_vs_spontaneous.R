...
library(ggpubr)
A <- merge_stats %>% dplyr::filter(Ca == "\"0.5 mM \" * Ca^\"2+\"",protocol=="singleAP")
B <- merge_stats %>% dplyr::filter(Ca == "\"0.5 mM \" * Ca^\"2+\"",protocol=="spont")

C <- merge_stats %>% dplyr::filter(Ca == "\"1 mM \" * Ca^\"2+\"",protocol=="singleAP")
D <- merge_stats %>% dplyr::filter(Ca == "\"1 mM \" * Ca^\"2+\"",protocol=="spont")

E <- merge_stats %>% dplyr::filter(Ca == "\"2 mM \" * Ca^\"2+\"",protocol=="singleAP")
F <- merge_stats %>% dplyr::filter(Ca == "\"2 mM \" * Ca^\"2+\"",protocol=="spont")

G <- merge_stats %>% dplyr::filter(Ca == "\"4 mM \" * Ca^\"2+\"",protocol=="singleAP")
H <- merge_stats %>% dplyr::filter(Ca == "\"4 mM \" * Ca^\"2+\"",protocol=="spont")
