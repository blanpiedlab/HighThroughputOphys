...
library(ggpubr)
A <- merge_stats %>% dplyr::filter(Ca == "\"0.5 mM \" * Ca^\"2+\"",protocol=="spont")
B <- merge_stats %>% dplyr::filter(Ca == "\"1 mM \" * Ca^\"2+\"",protocol=="spont")
C <- merge_stats %>% dplyr::filter(Ca == "\"2 mM \" * Ca^\"2+\"",protocol=="spont")
D <- merge_stats %>% dplyr::filter(Ca == "\"4 mM \" * Ca^\"2+\"",protocol=="spont")
