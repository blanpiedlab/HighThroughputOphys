my.theme<- theme(plot.title=element_text(size=40, family="sans"), 
                 plot.subtitle=element_text(size=40, family="sans"),
                 ...
                 legend.text=element_text(colour="black", size=25, family="sans"),
                 strip.text= element_text(colour="black", size=30, family="sans"),
