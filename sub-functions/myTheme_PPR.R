my.theme<- theme(plot.title=element_text(size=40, family="sans"), 
                 ...
                 axis.text.x=element_text(angle=45,colour="black", size=36, family="sans",margin=margin(5,0,0,0)),
                 axis.text.y=element_text(colour="black", size=36, family="sans"),
                 ...
                 legend.text=element_text(colour="black", size=30, family="sans"),
